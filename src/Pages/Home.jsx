  ...
  return (
    <div>
      <div className="px-10 mx-8 lg:mx-10 md:mx-8">
        <div className="container flex items-center justify-between h-full mx-auto bg-white/20 bg-[url('/12.png')] bg-cover  bg-center rounded-[40px] xl:h-[470px]">
          <div className=" flex flex-col justify-end gap-5 w-[20vw]  h-full ">
            ...
            <div className="flex justify-center w-full pb-10">
              <button className="relative flex items-center justify-center rounded-lg w-[70%] h-11 px-2 py-3 text-2xl bg-white text-black font-bold overflow-hidden group">
          ...
          <div className="  w-[50vw]  h-full flex flex-col items-center ">
            <h2 className=" relative flex  gap-[50px]  font-bold font-lilita-one text-gray-950  text-[230px] z-0 ">
              <h1>D</h1>
              <h1>O</h1>
              <h1>T</h1>
              <h1>S</h1>
